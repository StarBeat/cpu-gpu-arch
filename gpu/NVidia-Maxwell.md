...
1. [CUDA Tuning Guide](https://docs.nvidia.com/cuda/pdf/Maxwell_Tuning_Guide.pdf), [[backup](../pdf/NV-Maxwell_Tuning_Guide.pdf)]
2. [Architecture Whitepaper](https://www.techpowerup.com/gpu-specs/docs/nvidia-gtx-980.pdf), [[backup](../pdf/NV-gtx-980.pdf)]
3. [Dissecting GPU Memory Hierarchy through Microbenchmarking](https://arxiv.org/pdf/1509.02308), [[backup](../pdf/NV-Maxwell_microbench.pdf)]
